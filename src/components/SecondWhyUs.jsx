...
const SecondWhyUs = ({ title2, text, linkText, img }) => {
  return (
    <section className="slide-in-left">
      <div className="w-full md:flex items-center flex-row-reverse gap-20 justify-between">
        ...
        <div className="w-full md:w-[50%]">
          <img
            src={img}
            className="rounded-tr-[60px] rounded-bl-[60px] w-full h-full px-4 object-contain"
            alt="whyus"
          />
        </div>
      </div>
